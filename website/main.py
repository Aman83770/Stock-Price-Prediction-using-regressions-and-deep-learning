...
def result_ONGC():
    ...
    # print (mydict)
    return render_template('output_ONGC.html')
...
def result_LT():
    ...
    #   mydict = {rows[0]:rows[1] for rows in reader}
    # print (mydict)
    return render_template('output_LT.html')
...
def result_INFO():
    ...
    #   mydict = {rows[0]:rows[1] for rows in reader}
    # print (mydict)
    return render_template('output_INFO.html')
...
def result_TATA():
    return render_template('output_TATA.html')
